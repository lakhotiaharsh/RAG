...
def chat(query_input: QueryInput):
    ...
    contextualise = contextualise_q(query_input.question,chat_history)

    # run the pipeline directly; it will return the generated answer string
    answer=get_rag_chain(contextualise, chat_history)
